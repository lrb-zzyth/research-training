...
async def start_training(
    ...
    param_to_flag = {
        ...
        "lambda_cl": "--lambda_cl",
        "cl_tau": "--cl_tau",
        "gradate_tau": "--gradate_tau",
        "gradate_edge_drop_rate": "--gradate_edge_drop_rate",
        "gradate_beta": "--gradate_beta",
        "gradate_gamma": "--gradate_gamma",
        "gradate_alpha": "--gradate_alpha",
        "gradate_subgraph_size": "--gradate_subgraph_size",
        "gradate_negsamp_ratio_patch": "--gradate_negsamp_ratio_patch",
        "gradate_negsamp_ratio_context": "--gradate_negsamp_ratio_context",
